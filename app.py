...
try:
    ...
    if len(cleaned_rows) <= 1:
        ...
        # -----------------------------------------------------------------
        # 🏆 SEASON STANDINGS LEADERBOARD (Moved to Premium Top Position)
        # -----------------------------------------------------------------
        st.markdown("---")
        ...
        # -----------------------------------------------------------------
        # 📉 WEEKLY POSITION TRACKER LINE GRAPH (Moved Below Data Section)
        # -----------------------------------------------------------------
        st.markdown("---")
        if last_game_date:
        ...
        # -----------------------------------------------------------------
        # 📈 VISUAL BAR CHART (Relocated to the Absolute Bottom of Page)
        # -----------------------------------------------------------------
        st.markdown("---")
